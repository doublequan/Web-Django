...
def index(request):
    site_notice = get_object_or_404(SiteNotice)
...
def newest(request):
    items = [{
        "title": "有近期<b>pure<b> storage onsite的吗，求联系一起讨论，毕业前找到工作的最后希望之一！",
        ...
        "source": "1point3acres",
        "desc": " x如题，求近期一起有去pure storage onsite的同学吗？求一起讨论学习，加qq552017575。有前辈面过的可以在此帖下留下面筋题目，小弟不甚感激。\
